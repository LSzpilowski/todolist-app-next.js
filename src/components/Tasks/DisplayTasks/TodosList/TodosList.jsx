...
export const TodosList = ({todos, editingIndex, editingText, setEditingText, handleEditKeyPress, handleEditSave, handleEditCancel, handleEditStart, handleDone, handleDelete }) => {
  return (
    <U.Fieldset>
          <U.Legend>
            Todo's List {todos.length > 0 ? `(${todos.length})` : ""}
          </U.Legend>
          {/* Change to TodosList extend it */}
          <U.UnorderdList>
